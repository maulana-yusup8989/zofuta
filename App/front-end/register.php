                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Silakan Daftar Akun</h1>
                                    </div>
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="name" class="form-control form-control-user" id="name" placeholder="Name Lengkap">
                                        </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" id="email" aria-describedby="emailHelp" placeholder="Email">
                                        </div>
                                        <div class="form-group">
                                            <input type="no_hp" class="form-control form-control-user" id="no_hp" placeholder="+62">
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="password" class="form-control form-control-user" id="password" placeholder="katasandi">
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="repeat_password" class="form-control form-control-user" id="repeat_password" placeholder="Konfirmasi katasandi">
                                            </div>
                                        </div>
